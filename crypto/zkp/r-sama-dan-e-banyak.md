...
io.recvuntil("p = ")
p = int(io.readline().decode())
io.recvuntil("g = ")
g = int(io.readline().decode())
io.recvuntil("y = ")
y = int(io.readline().decode())
io.recvuntil("r = ")
r = int(io.readline().decode())

io.recvuntil("e = ")
e1 = int(io.readline().decode())

io.sendlineafter(b": \n", b"2")

io.recvuntil("s = ")
s1 = int(io.readline().decode())
...
io.recvuntil("e = ")
e2 = int(io.readline().decode())

io.sendlineafter(b": \n", b"2")

io.recvuntil("s = ")
s2 = int(io.readline().decode())
